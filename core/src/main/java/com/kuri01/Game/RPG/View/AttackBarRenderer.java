...
public class AttackBarRenderer extends Renderer {
    public AttackBarRenderer(GameScreen gameScreen) {
        super(gameScreen);
    }
    public void renderAttackBar(ShapeRenderer shapeRenderer, AttackBar bar, float x, float y, float width, float height) {
